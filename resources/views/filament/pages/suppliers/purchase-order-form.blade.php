...
<x-filament-panels::page>
    <div
        class="ci-wajebaty ci-purchase-order-form-page -mx-4 -mt-8 px-4 pb-10 pt-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
        dir="rtl"
    >
        @include('filament.partials.wajebaty-theme-styles')

        <style>
            .ci-purchase-order-form-page .ci-so-title {
                text-align: center;
                font-size: 1.25rem;
                font-weight: 700;
            ...
            .ci-purchase-order-form-page .ci-so-top-grid {
                display: grid;
            ...
            .ci-purchase-order-form-page .ci-so-balance .k {
                font-size: 0.75rem;
                color: rgba(255, 255, 255, 0.65);
            }

            .ci-purchase-order-form-page .ci-so-balance .v {
                font-size: 1.1rem;
                font-weight: 700;
                color: #fbbf24;
            }

            .ci-purchase-order-form-page .ci-so-supplier-table {
                width: 100%;
            ...
            .ci-purchase-order-form-page .ci-so-supplier-table td {
                border: 1px solid var(--ci-line);
        ...
        <div class="ci-so-title">امر الشراء</div>
        ...
        <x-filament-panels::form id="purchase-order-form" wire:submit="save">
            {{ $this->form }}
