<x-filament-panels::page>
    <div
        class="ci-wajebaty ci-payroll-wajebaty ci-reports-page ci-balance-sheet-page -mx-4 -mt-8 px-4 pb-10 pt-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
        dir="rtl"
        wire:key="balance-sheet-{{ \Filament\Facades\Filament::getTenant()?->getKey() }}"
    >
        ...
        <div class="ci-rep-title">قائمة المركز المالي</div>

        <div class="ci-card ci-form-inner ci-reports-card ci-rep-no-print">
            <div class="ci-rep-filters">
                <div class="ci-rep-field">
                    <label for="balance-date-from">الفترة من :</label>
                    <input id="balance-date-from" type="date" wire:model="dateFrom" />
                </div>
                <div class="ci-rep-field">
                    <label for="balance-date-to">إلى :</label>
                    <input id="balance-date-to" type="date" wire:model="dateTo" />
                </div>
                <x-filament::button
                    type="button"
                    wire:click="search"
