<x-filament-panels::page>
    <div
        class="ci-wajebaty ci-payroll-wajebaty ci-employee-definition-form-page -mx-4 -mt-8 px-4 pb-10 pt-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
        dir="rtl"
    >
        ...
        <div class="ci-card ci-form-inner ci-payroll-form-card">
            ...
            <x-filament-panels::form id="employee-definition-form" wire:submit="save">
                {{ $this->form }}
