...
final class SalesOrderFormPage extends Page
{
    use InteractsWithFormActions;

    protected static ?string $slug = 'sales-order-form';

    protected static string $view = 'filament.pages.customers.sales-order-form';
    ...
    public function mount(): void
    {
        ...
        if ($editId !== null && $editId !== '') {
            ...
            $this->form->fill($this->salesOrderToFormData($order));
        } else {
            $this->form->fill([
                'order_number' => SalesOrder::nextOrderNumber($tenant->id),
     ...
     */
    protected function salesOrderToFormData(SalesOrder $order): array
    {
        return [
            'id' => $order->id,
            ...
            'notes' => $order->notes,
            'lines' => $order->lines->map(fn (SalesOrderLine $line, int $index): array => [
    ...
    public function save(): void
    {
        ...
        DB::transaction(function () use ($tenant, $customer, $data, $lines, $total): void {
            $payload = [
            ...
            if (! empty($data['id'])) {
                ...
                $payload['order_number'] = (int) ($data['order_number'] ?? SalesOrder::nextOrderNumber($tenant->id));
        ...
        $this->redirect(SalesOrderPage::getUrl(['tenant' => $tenant]));
    }
    ...
    protected function getFormActions(): array
    {
        return [
            ...
            Action::make('back')
                ...
                ->url(fn (): string => SalesOrderPage::getUrl(['tenant' => Filament::getTenant()])),
        ];
    }
