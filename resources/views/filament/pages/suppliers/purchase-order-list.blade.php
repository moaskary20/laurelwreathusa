<x-filament-panels::page>
    <div
        class="ci-wajebaty ci-purchase-order-list-page -mx-4 -mt-8 px-4 pb-10 pt-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
        wire:key="purchase-order-list-{{ \Filament\Facades\Filament::getTenant()?->getKey() }}"
        dir="rtl"
    >
        @include('filament.partials.wajebaty-theme-styles')

        <style>
            .ci-purchase-order-list-page .ci-card__head-po h2 {
                font-size: 1.15rem;
                font-weight: 700;
                color: #fff;
            }

            .ci-purchase-order-list-page .ci-table-shell .fi-ta {
            ...
            .ci-purchase-order-list-page .ci-table-shell .fi-ta-text,
            .ci-purchase-order-list-page .ci-table-shell .fi-ta-text-item {
                color: rgba(255, 255, 255, 0.88) !important;
            }

            .ci-purchase-order-list-page .ci-table-shell .fi-ac-btn {
        ...
        <div class="ci-banner">
            <div class="ci-banner__main">
                ...
                <div class="min-w-0">
                    <div class="ci-banner__title">اوامر الشراء</div>
                    <div class="ci-banner__sub">عرض وإدارة أوامر الشراء للموردين</div>
                </div>
            </div>
        </div>

        <div class="ci-card ci-form-inner ci-purchase-order-list-page">
            <div class="ci-card__head ci-card__head-po">
                <x-filament::icon icon="heroicon-o-table-cells" class="h-5 w-5" />
                <h2>قائمة اوامر الشراء</h2>
            </div>
