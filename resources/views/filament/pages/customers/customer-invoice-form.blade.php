...
<x-filament-panels::page>
    <div
        class="ci-wajebaty ci-customer-invoice-form-page -mx-4 -mt-8 px-4 pb-10 pt-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
        dir="rtl"
    >
        @include('filament.partials.wajebaty-theme-styles')

        <style>
            .ci-customer-invoice-form-page .ci-so-title {
                text-align: center;
                font-size: 1.25rem;
                font-weight: 700;
            ...
            .ci-customer-invoice-form-page .ci-so-top-grid {
                display: grid;
            ...
            .ci-customer-invoice-form-page .ci-so-balance {
            ...
            .ci-customer-invoice-form-page .ci-so-balance .k {
                font-size: 0.75rem;
                color: rgba(255, 255, 255, 0.65);
            }

            .ci-customer-invoice-form-page .ci-so-balance .v {
                font-size: 1.1rem;
                font-weight: 700;
                color: #fbbf24;
            }

            .ci-customer-invoice-form-page .ci-so-company-box {
                border-radius: 0.5rem;
                border: 1px solid var(--ci-line);
            ...
            .ci-customer-invoice-form-page .ci-so-company-box dt {
                color: rgba(255, 255, 255, 0.55);
                display: inline;
            }

            .ci-customer-invoice-form-page .ci-so-company-box dd {
                display: inline;
                margin-inline-start: 0.35rem;
            }

            .ci-customer-invoice-form-page .ci-so-customer-table {
                width: 100%;
            ...
            .ci-customer-invoice-form-page .ci-so-customer-table th,
            .ci-customer-invoice-form-page .ci-so-customer-table td {
                border: 1px solid var(--ci-line);
        ...
        <div class="ci-so-title">فاتورة مبيعات</div>
        ...
        <x-filament-panels::form id="customer-invoice-form" wire:submit="save">
            {{ $this->form }}
